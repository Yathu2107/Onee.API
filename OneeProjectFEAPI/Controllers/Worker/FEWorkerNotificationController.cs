...
namespace OneeProjectFEAPI.Controllers.Worker
{
    [Authorize]
    [ApiController]
    public class FEWorkerNotificationController(FEWorkerNotificationService notificationService) : ControllerBase
    {
        private const string API_ROUTE_NAME = "api/v1/worker/notifications";
        private readonly FEWorkerNotificationService _notificationService = notificationService;
