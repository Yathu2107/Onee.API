...
namespace OneeProjectFEAPI.Controllers.Worker
{
    [Authorize]
    [ApiController]
    public class FEWorkerAddressController(FEWorkerAddressService addressService) : ControllerBase
    {
        private const string API_ROUTE_NAME = "api/v1/worker/addresses";
        private readonly FEWorkerAddressService _addressService = addressService;
