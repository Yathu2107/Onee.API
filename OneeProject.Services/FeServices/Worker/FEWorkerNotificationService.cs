...
{
    /// <summary>
    /// Worker app inbox shows Admin Panel broadcasts only (not job/chat system pushes).
    /// </summary>
    public class FEWorkerNotificationService(NotificationService notificationService)
    {
